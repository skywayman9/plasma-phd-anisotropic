...
colorbar
freezeColors
clabel(cs,h), title('streamfunction ( m^2/s times 1.e-7), and velocity (arrows)')
axis([-Lx/2 Lx/2 -Ly/4  Ly/4 ])
...
%axis([ -Lx/2 Lx/2 -Ly/4  Ly/4 ])
%clabel(cs,h)
title('finite difference vorticity estimate (s^-^1 times 1.E5)')
xlabel('x (km)'), ylabel('y (km)')

subplot(2,1,2)
hold off
[c,h]=contour(xx,yy,zeta-zetad);
colorbar
title('vorticity - finite amplitude vorticity estimate (s^-^1 times 1.E5)')
xlabel('x (km)'), ylabel('y (km)')
