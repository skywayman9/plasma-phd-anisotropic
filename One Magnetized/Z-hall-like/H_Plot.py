...
g=48*m	
k=48*m
x = np.linspace(0.0,.020,g)
y = np.linspace(0.01,.020,k)
...
plt.savefig('Potential_New_WENO_1000.pdf',dpi=600,bbox_inches='tight', pad_inches = 0)
plt.show()
...
plt.xlim(0.0,0.020)
plt.ylim(0.01,.020)
plt.savefig('Electron_streamlines_NEW_WENO_1000_1.pdf',dpi=600,bbox_inches='tight', pad_inches = 0)
plt.show()
